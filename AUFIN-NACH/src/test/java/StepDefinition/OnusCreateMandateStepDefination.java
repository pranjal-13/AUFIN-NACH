...
public void user_enters_and_upload_and_clicks_on_ok_button(String Name, String Account_Number, String Amount, String Customer_Name, String Customer_Code, String IFSC_Code, String Image1, String Image2) throws InterruptedException {
   
	createONUSMandate=createONUSMandate.EnterDetails(Name, Account_Number, Amount, Customer_Name, Customer_Code, IFSC_Code, Image1, Image2);
    Thread.sleep(IntfConstants.TIMEOUT);
