...
public class CancelInwardMandateStepDefination extends TestBase {
	...
	public void user_goes_to_GPS_application_and_select_Mandate_Management_and_clicks_on_Accept_Mandate_menu()
	...
	public void user_goes_to_Application_and_select_Mandate_Management_and_clicks_to_Approve_Mandate_screen()
			throws InterruptedException {
		Initialization();
		win = new Windowhandle(driver);
		loginPage = new LoginPage();
	...
	public void user_will_validate_the_cancel_inward_mandate_in_list_mandate_menu() throws InterruptedException {
		...
		Thread.sleep(IntfConstants.TIMEOUT);
		driver.switchTo().frame("toc");
		cancelInwardMandate=homePage.listCancelInwardMandate();
		cancelInwardMandate = cancelInwardMandate.ViewingMandate();
		driver.quit();
	}
