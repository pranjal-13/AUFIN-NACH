...
public class HomePage extends TestBase {
	...
	//Cancel List
	public CancelOutwardMandate listCancelOutwardMandate() throws InterruptedException {
		applicationLink.click();
		mandateManagementLink.click();
		mandateManagementListMandatesLink.click();
		win.handlewin();
	...
	//Cancel Inward Mandate List
	public CancelInwardMandate listCancelInwardMandate() throws InterruptedException {
		applicationLink.click();
		mandateManagementLink.click();
		mandateManagementListMandatesLink.click();
		win.handlewin();
