...
//	driver.switchTo().window(menuWindow); // switch back to parent window
	...
	public void handlewin4(String ExpectedTitle,SoftAssert sa ) {
		System.out.println("Expected Title=" + ExpectedTitle);
			String mainWindow=driver.getWindowHandle();
		 // It returns no. of windows opened by WebDriver and will return Set of Strings
		 Set<String> set =driver.getWindowHandles();
	...
	public void verifyPages1(String key , SoftAssert sa) throws ParserConfigurationException {	
		handlewin3(xmlFileReader2.mapTitle.get(key),sa);
	}
}
